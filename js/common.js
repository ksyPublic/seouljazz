...
// function ajaxpopup(url, time, bguse, tmsg, tscore) {
//   //url은 url, time은 fade 인아웃 시간, bguse 는 검은배경 사용여부 false는사용안함
//   $.ajax({
//     type: "POST",
//     url: url,
//     data: "",
...
//       if (bguse != false) {
//         if ($(".popup_bg, .popup_contents").length < 1) {
//           $("body").append(
//             '<div class="popup_bg"></div><div class="popup_contents">' +
//               data +
//               "</div>"
//           );
//           if (tmsg != "") {
//             $(".result .tmsg").text(tmsg);
//             $("#tscore").text(tscore);
//           }
//         }
//         $(".popup_contents > div").append(
//           '<a class="btn_close" href="#none">닫기</a>'
//         );
//         $(".popup_bg, .popup_contents")
//           .stop()
//           .fadeIn(time);
...
//               $(".popup_bg, .popup_contents").remove();
//             });
//         });
//       }
//     },
  ...
  $(function() {
    ...
    function allm() {
      ...
      $(".all_menu").click(function() {
        ...
        $(".hidden_menu").prepend(
          '<a href="#none" class="hdb_btn" onclick="javascript:return false;"></a>'
        );
